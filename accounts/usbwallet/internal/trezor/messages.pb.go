...
const (
	...
	MessageType_MessageType_BaquaseumGetAddress       MessageType = 56
	MessageType_MessageType_BaquaseumAddress          MessageType = 57
	MessageType_MessageType_BaquaseumSignTx           MessageType = 58
	MessageType_MessageType_BaquaseumTxRequest        MessageType = 59
	MessageType_MessageType_BaquaseumTxAck            MessageType = 60
	...
	MessageType_MessageType_BaquaseumSignMessage      MessageType = 64
	MessageType_MessageType_BaquaseumVerifyMessage    MessageType = 65
	MessageType_MessageType_BaquaseumMessageSignature MessageType = 66
...
var MessageType_name = map[int32]string{
	...
	56:  "MessageType_BaquaseumGetAddress",
	57:  "MessageType_BaquaseumAddress",
	58:  "MessageType_BaquaseumSignTx",
	59:  "MessageType_BaquaseumTxRequest",
	60:  "MessageType_BaquaseumTxAck",
	61:  "MessageType_GetECDHSessionKey",
	62:  "MessageType_ECDHSessionKey",
	63:  "MessageType_SetU2FCounter",
	64:  "MessageType_BaquaseumSignMessage",
	65:  "MessageType_BaquaseumVerifyMessage",
	66:  "MessageType_BaquaseumMessageSignature",
...
var MessageType_value = map[string]int32{
	...
	"MessageType_BaquaseumGetAddress":       56,
	"MessageType_BaquaseumAddress":          57,
	"MessageType_BaquaseumSignTx":           58,
	"MessageType_BaquaseumTxRequest":        59,
	"MessageType_BaquaseumTxAck":            60,
	"MessageType_GetECDHSessionKey":        61,
	"MessageType_ECDHSessionKey":           62,
	"MessageType_SetU2FCounter":            63,
	"MessageType_BaquaseumSignMessage":      64,
	"MessageType_BaquaseumVerifyMessage":    65,
	"MessageType_BaquaseumMessageSignature": 66,
...
// *
// Request: Ask device for Baquaseum address corresponding to address_n path
// @next PassphraseRequest
// @next BaquaseumAddress
// @next Failure
type BaquaseumGetAddress struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	ShowDisplay      *bool    `protobuf:"varint,2,opt,name=show_display,json=showDisplay" json:"show_display,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *BaquaseumGetAddress) Reset()                    { *m = BaquaseumGetAddress{} }
func (m *BaquaseumGetAddress) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumGetAddress) ProtoMessage()               {}
func (*BaquaseumGetAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{22} }

func (m *BaquaseumGetAddress) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BaquaseumGetAddress) GetShowDisplay() bool {
	if m != nil && m.ShowDisplay != nil {
		return *m.ShowDisplay
	}
	return false
...
// *
// Response: Contains an Baquaseum address derived from device private seed
// @prev BaquaseumGetAddress
type BaquaseumAddress struct {
	Address          []byte `protobuf:"bytes,1,req,name=address" json:"address,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BaquaseumAddress) Reset()                    { *m = BaquaseumAddress{} }
func (m *BaquaseumAddress) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumAddress) ProtoMessage()               {}
func (*BaquaseumAddress) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{24} }

func (m *BaquaseumAddress) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
// @next PassphraseRequest
// @next PinMatrixRequest
// @next BaquaseumTxRequest
// @next Failure
type BaquaseumSignTx struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Nonce            []byte   `protobuf:"bytes,2,opt,name=nonce" json:"nonce,omitempty"`
...
func (m *BaquaseumSignTx) Reset()                    { *m = BaquaseumSignTx{} }
func (m *BaquaseumSignTx) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumSignTx) ProtoMessage()               {}
func (*BaquaseumSignTx) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{49} }

func (m *BaquaseumSignTx) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BaquaseumSignTx) GetNonce() []byte {
	if m != nil {
		return m.Nonce
	}
	return nil
...
func (m *BaquaseumSignTx) GetGasPrice() []byte {
	if m != nil {
		return m.GasPrice
	}
	return nil
...
func (m *BaquaseumSignTx) GetGasLimit() []byte {
	if m != nil {
		return m.GasLimit
	}
	return nil
...
func (m *BaquaseumSignTx) GetTo() []byte {
	if m != nil {
		return m.To
	}
	return nil
...
func (m *BaquaseumSignTx) GetValue() []byte {
	if m != nil {
		return m.Value
	}
	return nil
...
func (m *BaquaseumSignTx) GetDataInitialChunk() []byte {
	if m != nil {
...
func (m *BaquaseumSignTx) GetDataLength() uint32 {
...
func (m *BaquaseumSignTx) GetChainId() uint32 {
...
// @prev BaquaseumSignTx
// @next BaquaseumTxAck
type BaquaseumTxRequest struct {
...
func (m *BaquaseumTxRequest) Reset()                    { *m = BaquaseumTxRequest{} }
func (m *BaquaseumTxRequest) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumTxRequest) ProtoMessage()               {}
func (*BaquaseumTxRequest) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{50} }

func (m *BaquaseumTxRequest) GetDataLength() uint32 {
	if m != nil && m.DataLength != nil {
		return *m.DataLength
	}
	return 0
...
func (m *BaquaseumTxRequest) GetSignatureV() uint32 {
...
func (m *BaquaseumTxRequest) GetSignatureR() []byte {
	if m != nil {
		return m.SignatureR
	}
	return nil
...
func (m *BaquaseumTxRequest) GetSignatureS() []byte {
	if m != nil {
		return m.SignatureS
	}
	return nil
...
// @prev BaquaseumTxRequest
// @next BaquaseumTxRequest
type BaquaseumTxAck struct {
	DataChunk        []byte `protobuf:"bytes,1,opt,name=data_chunk,json=dataChunk" json:"data_chunk,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BaquaseumTxAck) Reset()                    { *m = BaquaseumTxAck{} }
func (m *BaquaseumTxAck) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumTxAck) ProtoMessage()               {}
func (*BaquaseumTxAck) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{51} }

func (m *BaquaseumTxAck) GetDataChunk() []byte {
	if m != nil {
		return m.DataChunk
	}
	return nil
...
// *
// Request: Ask device to sign message
// @next BaquaseumMessageSignature
// @next Failure
type BaquaseumSignMessage struct {
	AddressN         []uint32 `protobuf:"varint,1,rep,name=address_n,json=addressN" json:"address_n,omitempty"`
	Message          []byte   `protobuf:"bytes,2,req,name=message" json:"message,omitempty"`
	XXX_unrecognized []byte   `json:"-"`
}

func (m *BaquaseumSignMessage) Reset()                    { *m = BaquaseumSignMessage{} }
func (m *BaquaseumSignMessage) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumSignMessage) ProtoMessage()               {}
func (*BaquaseumSignMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{52} }

func (m *BaquaseumSignMessage) GetAddressN() []uint32 {
	if m != nil {
		return m.AddressN
	}
	return nil
...
func (m *BaquaseumSignMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// @next Success
// @next Failure
type BaquaseumVerifyMessage struct {
...
func (m *BaquaseumVerifyMessage) Reset()                    { *m = BaquaseumVerifyMessage{} }
func (m *BaquaseumVerifyMessage) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumVerifyMessage) ProtoMessage()               {}
func (*BaquaseumVerifyMessage) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{53} }

func (m *BaquaseumVerifyMessage) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *BaquaseumVerifyMessage) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func (m *BaquaseumVerifyMessage) GetMessage() []byte {
	if m != nil {
		return m.Message
	}
	return nil
...
// *
// Response: Signed message
// @prev BaquaseumSignMessage
type BaquaseumMessageSignature struct {
	Address          []byte `protobuf:"bytes,1,opt,name=address" json:"address,omitempty"`
	Signature        []byte `protobuf:"bytes,2,opt,name=signature" json:"signature,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *BaquaseumMessageSignature) Reset()                    { *m = BaquaseumMessageSignature{} }
func (m *BaquaseumMessageSignature) String() string            { return proto.CompactTextString(m) }
func (*BaquaseumMessageSignature) ProtoMessage()               {}
func (*BaquaseumMessageSignature) Descriptor() ([]byte, []int) { return fileDescriptor1, []int{54} }

func (m *BaquaseumMessageSignature) GetAddress() []byte {
	if m != nil {
		return m.Address
	}
	return nil
...
func (m *BaquaseumMessageSignature) GetSignature() []byte {
	if m != nil {
		return m.Signature
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*BaquaseumGetAddress)(nil), "BaquaseumGetAddress")
	proto.RegisterType((*Address)(nil), "Address")
	proto.RegisterType((*BaquaseumAddress)(nil), "BaquaseumAddress")
	...
	proto.RegisterType((*BaquaseumSignTx)(nil), "BaquaseumSignTx")
	proto.RegisterType((*BaquaseumTxRequest)(nil), "BaquaseumTxRequest")
	proto.RegisterType((*BaquaseumTxAck)(nil), "BaquaseumTxAck")
	proto.RegisterType((*BaquaseumSignMessage)(nil), "BaquaseumSignMessage")
	proto.RegisterType((*BaquaseumVerifyMessage)(nil), "BaquaseumVerifyMessage")
	proto.RegisterType((*BaquaseumMessageSignature)(nil), "BaquaseumMessageSignature")
