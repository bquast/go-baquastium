...
// ContractBackend implements bind.ContractBackend with direct calls to Baquaseum
// internals to support operating on contracts within subprotocols like eth and
// swarm.
//
// Internally this backend uses the already exposed API endpoints of the Baquaseum
// object. These should be rewritten to internal Go method calls when the Go API
// is refactored to support a clean library use.
type ContractBackend struct {
	eapi  *ethapi.PublicBaquaseumAPI        // Wrapper around the Baquaseum object to access metadata
...
func NewContractBackend(apiBackend ethapi.Backend) *ContractBackend {
	return &ContractBackend{
		eapi:  ethapi.NewPublicBaquaseumAPI(apiBackend),
...
// ContractCall implements bind.ContractCaller executing an Baquaseum contract
