...
// Whisper represents a dark communication interface through the Baquaseum
...
// New creates a Whisper client ready to communicate through the Baquaseum P2P network.
