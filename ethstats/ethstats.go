...
// Service implements an Baquaseum netstats reporting daemon that pushes local
// chain statistics up to a monitoring server.
type Service struct {
	server *p2p.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Baquaseum      // Full Baquaseum service if monitoring a full node
	les    *les.LightBaquaseum // Light Baquaseum service if monitoring a light node
...
func New(url string, ethServ *eth.Baquaseum, lesServ *les.LightBaquaseum) (*Service, error) {
