...
// PrecompiledContractsHomestead contains the default set of pre-compiled Baquaseum
...
// PrecompiledContractsByzantium contains the default set of pre-compiled Baquaseum
