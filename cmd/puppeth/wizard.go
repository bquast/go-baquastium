...
type wizard struct {
	...
	services map[string][]string   // Baquaseum services known to be running on servers
...
// converts it to an Baquaseum address. If an empty line is entered, the default
// value is returned.
