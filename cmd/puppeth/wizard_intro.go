...
// setting up a new or managing an existing Baquaseum private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Baquaseum private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Baquaseum network down to  |")
	...
	log.Info("Administering Baquaseum network", "name", w.network)
